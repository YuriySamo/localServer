...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="left">
      ...
      <div class="image"> 
      <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class = 'cloud-zoom' id='zoom1' rel="position: 'right' ,showTitle:true, adjustX:-0, adjustY:-4" >
   ...
   <a href="<?php echo $image['popup']; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom-gallery" rel="useZoom: 'zoom1', smallImage: '<?php echo $image['thumb']; ?>' "><img src="<?php echo $image['small']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
    ...
    <div class="right">
      ...
      <div class="description">
        ...
        <span><?php echo $text_reward; ?></span> <strong><?php echo $reward; ?></strong><br />
      <div class="padd-avalib"> <div class="extra-wrap"> <span class="prod-stock-2"><?php echo $text_stock; ?></span> <div class="prod-stock"><?php echo $stock; ?></div></div></div></div>
      <?php if ($price) { ?>
      <div class="price"><?php echo $text_price; ?>
        <?php if (!$special) { ?>
       <span class="price-prod-page"> <?php echo $price; ?><span>
        <?php } else { ?>
      ...
      <div class="cart"><div class="prod-row">
        <div class="cart-top">
       <div class="cart-top-padd">   <label><?php echo $text_qty; ?></label>
          <input class="input-qti" type="text" name="quantity" size="2" value="<?php echo $minimum; ?>" />
          <input type="hidden" name="product_id" size="2" value="<?php echo $product_id; ?>" /></div>
          &nbsp;<a id="button-cart" class="button-prod"><?php echo $button_cart; ?></a></div>
  
        <div class="extra-button">      <div class="wishlist"><a class="tip"  onclick="addToWishList('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a><span class="tooltip">Wishlist</span></div>
      <div class="compare"><a class="tip2"  onclick="addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a><span class="tooltip2">Compare</span></div>
   </div>
      ...
      <div class="review">
        <div><img src="catalog/view/theme/theme005/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<div class="btn-rew"><a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div></div>
...
<!-- AddThis Button END -->
  ...
  <div id="tab-review" class="tab-content">
    ...
    <span style="font-size: 11px; margin-bottom:5px; display:block"><?php echo $text_note; ?></span>
    <b class="bb_rew"><?php echo $entry_rating; ?></b> <span><?php echo $entry_bad; ?></span>&nbsp;
    ...
    <br />
    <b class="bb-2"><?php echo $entry_captcha; ?></b>
  ...
  <?php echo $content_bottom; ?></div>
   ...
   <div class="extra-wrap"> <div class="box-product"> 
      ...
      <li class="related-info">
        ...
        <div class="rating"><img src="catalog/view/theme/theme005/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" /></div>
        <?php } ?>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme005/image/loading.gif" class="loading" style="padding-left: 5px;" />');
	},
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme005/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
