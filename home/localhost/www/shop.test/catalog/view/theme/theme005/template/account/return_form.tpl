...
<div id="content"><?php echo $content_top; ?>
  ...
  <?php } ?>
  <div class="return-p"><?php echo $text_description; ?></div>
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="return">
    
    <div class="content return-box"><h2><?php echo $text_order; ?></h2>
      <div class="left"><span class="required">*</span> <label><?php echo $entry_firstname; ?></label><br />
...
<br />
        ...
        <span class="required">*</span> <label><?php echo $entry_lastname; ?></label><br />
...
<br />
        ...
        <span class="required">*</span> <label><?php echo $entry_email; ?></label><br />
...
<br />
        ...
        <span class="required">*</span> <label><?php echo $entry_telephone; ?><br /></label>
...
<br />
      ...
      <div class="right"><span class="required">*</span> <label><?php echo $entry_order_id; ?></label><br />
...
<br />
      ...
      <label>  <?php echo $entry_date_ordered; ?><br /></label>
        <input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" class="large-field date" />
<br />
      </div>
    </div>
   <div class="return-box-2"> <h2><?php echo $text_product; ?></h2>
    ...
    <div class="buttons">
      ...
      <div class="right"><a onclick="$('#return').submit();" class="button-return-right"><span><?php echo $button_continue; ?></span></a></div>
    </div></div>
  </form>
