...
<div class="shop-cart">        <table>
          <thead>
            <tr>
              ...
              <td style="border-right:0;" class="total"><?php echo $column_total; ?></td>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td  style="border-right:0;" class="total"><?php echo $product['total']; ?></td>
            </tr>
            <?php } ?>
   ...
   <div class="cart-bottom"> <div class="cart-total">
      <table>
        <?php foreach ($totals as $total) { $count +=1; ?>
        <tr class="row-table-<?php echo $count; ?>">
          <td class="right" style="border-bottom:1px solid #dfe1e4;border-right:1px solid #dfe1e4; color:#191919; width:87%"><b><?php echo $total['title']; ?>:</b></td>
          <td class="right last-td" style="border-bottom:1px solid #dfe1e4; font-size:17px; font-weight:bold; color:#5c5c5c; text-align:center"><?php echo $total['text']; ?></td>
        </tr>
        <?php } ?>
      </table>
    </div>
