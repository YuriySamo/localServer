...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="checkout" >
    <div id="checkout" >
      <div class="checkout-heading" style="border-radius:6px 6px 0 0;"><div class="marker-chekout"><?php echo $text_checkout_option; ?></div></div>
    ...
    <div id="confirm"  >
      <div class="checkout-heading" style="border-radius:0 0 6px 6px;border-bottom: 1px solid #dfe1e4;"><div class="marker-chekout"><?php echo $text_checkout_confirm; ?></div></div>
      <div class="checkout-content" style="border-bottom: 1px solid #DFE1E4; border-radius:6px 6px 6px 6px; margin-top:7px;"></div>
    </div>
  </div>
  <br />
  <br />
