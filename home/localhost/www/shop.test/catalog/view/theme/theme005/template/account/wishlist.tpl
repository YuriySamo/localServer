...
<div class="table-radius">      <table>
    ...
    <div class="left"><a href="<?php echo $back; ?>" class="button-wislish-left"><span><?php echo $button_back; ?></span></a></div>
    <div class="right"><a onclick="$('#wishlist').submit();" class="button-up"><?php echo $button_update; ?></a></div>
  </div></div>
    </div>
  </form>
