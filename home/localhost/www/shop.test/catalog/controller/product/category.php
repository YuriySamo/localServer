	...
	public function index() { 
		...
		if ($category_info) {
			...
			$this->data['limits'][] = array(
				'text'  => 96,
				'value' => 96,
				'href'  => $this->url->link('product/category', 'path=' . $this->request->get['path'] . $url . '&limit=96')
			);
			
			$this->data['limits'][] = array(
				'text'  => 192,
				'value' => 192,
				'href'  => $this->url->link('product/category', 'path=' . $this->request->get['path'] . $url . '&limit=192')
			);
