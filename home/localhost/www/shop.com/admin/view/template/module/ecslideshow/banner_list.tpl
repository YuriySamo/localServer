...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="heading">
      ...
      <div class="buttons"><a href="<?php echo $insert; ?>" class="button"><?php echo $button_insert; ?></a><a href="<?php echo $import; ?>" class="button"><?php echo $button_import; ?></a><a onclick="$('form').attr('action', '<?php echo $export; ?>');$('form').submit();" class="button"><?php echo $button_export; ?></a><a onclick="$('form').attr('action', '<?php echo $delete; ?>');$('form').submit();" class="button"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="content">
