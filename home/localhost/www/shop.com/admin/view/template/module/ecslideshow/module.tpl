                  ...
                  <td><?php echo $entry_store; ?></td>
                    ...
                    <?php echo $text_default; ?>
                      ...
                      <tr>
                       ...
                       <tr>
                        <td><?php echo $this->language->get("entry_resize_main_image"); ?></td>
                        <td><select name="ecslideshow_module[<?php echo $module_row; ?>][resize_image]">
                             <?php 
                             if($yesno){
                              foreach($yesno as $key=>$val){
                                if($key == $module['resize_image']){
                                ?>
                                  <option value="<?php echo $key; ?>" selected="selected"><?php echo $val; ?></option>
                                <?php
                                }else{
...
function addModule() {
 ...
 html +='                       <option value="<?php echo $banner['ecbanner_id'] ?>" selected="selected"><?php echo $banner['name']; ?></option>';
  ...
  html +='                    </tr>';
  html +='<tr>';
  html +='                      <td><?php echo $this->language->get("entry_resize_main_image"); ?></td>';
  html +='                      <td><select name="ecslideshow_module['+module_row+'][resize_image]">';
                            <?php 
                             if($yesno){
                              foreach($yesno as $key=>$val){
                                if($key == $default['resize_image']){
                                ?>
  html +='                                <option value="<?php echo $key; ?>" selected="selected"><?php echo $val; ?></option>';
                                <?php
                                }else{
