<div class="box">
  <div class="top"><img src="catalog/view/theme/default2/image/featured.png" alt="" /><?php echo $heading_title; ?></div>
  <div class="middle">
    <?php if ($products) { ?>
    <table cellpadding="2" cellspacing="0" style="width: 100%;">
      ...
      <tr>
        ...
        <td valign="top" ><a href="<?php echo str_replace('&', '&amp;', $product['href']); ?>"><?php echo $product['name']; ?></a>
          ...
          <?php } else { ?>
          <span style="font-size: 11px; color: #900; text-decoration: line-through;"><?php echo $product['price']; ?></span> <span style="font-size: 11px; color: #494949;"><br /><?php echo $product['special']; ?></span>
          <?php } ?>
