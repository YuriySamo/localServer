...
<div id="content">
  ...
  <div class="middle">
    ...
    <table class="list">
      ...
      <tr>
        ...
        <td width="25%"><?php if (isset($categories[$j])) { ?>
          <a href="<?php echo $categories[$j]['href']; ?>"><img src="<?php echo $categories[$j]['thumb']; ?>" title="<?php echo $categories[$j]['name']; ?>" alt="<?php echo $categories[$j]['name']; ?>" style="margin-bottom: 3px;" /></a><br /><br />
    ...
    <table class="list">
      ...
      <tr>
        <?php for ($j = $i; $j < ($i + 3); $j++) { ?>
        <td width="25%"><?php if (isset($products[$j])) { ?><br />
          <a href="<?php echo $products[$j]['href']; ?>"><img src="<?php echo $products[$j]['thumb']; ?>" title="<?php echo $products[$j]['name']; ?>" alt="<?php echo $products[$j]['name']; ?>" /></a><br /><br />
    ...
    <div class="box_price">
	  ...
	  <span style="color: #990000;font-size: 15px; font-weight: bold;"><?php echo $products[$j]['special']; ?></span>
      <?php } ?>
      <?php } ?>
	</div> 
