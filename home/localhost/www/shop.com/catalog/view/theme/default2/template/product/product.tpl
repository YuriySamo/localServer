        ...
        <tr>
          <td style="text-align: center; width: 250px; vertical-align: top;">
            <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="thickbox" rel="gallery">
              <img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" style="margin-bottom: 3px;" /><br />
            <span style="font-size: 11px;"><?php echo $text_enlarge; ?></span></a></td>
	      ...
	      <script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#username=xa-4cb894fd274c4f84"></script>
              ...
              <tr>
                ...
                <td><?php if (!$special) { ?>
                  <?php echo $price; ?>
                  <?php } else { ?>
                  <span style="text-decoration: line-through;"><?php echo $price; ?></span> <span style="color: #000000;"><?php echo $special; ?></span>
                  <?php } ?></td>
              </tr>
              <?php } ?>
              <tr>
    ...
    <div id="tab_image" class="tab_page">
      <div style="display: inline-block;">
        <?php foreach ($images as $image) { ?>
          ...
          <img src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" style="border: 1px solid #DDDDDD; margin-bottom: 3px;" /><br />
      ...
      <table class="list">
        ...
        <tr>
          ...
          <td width="25%"><?php if (isset($products[$j])) { ?>
            <a href="<?php echo str_replace('&', '&amp;', $products[$j]['href']); ?>"><img src="<?php echo $products[$j]['thumb']; ?>" title="<?php echo $products[$j]['name']; ?>" alt="<?php echo $products[$j]['name']; ?>" /></a><br /><br />
            ...
            <span style="color: #494949;font-size: 15px; font-weight: bold;"><?php echo $products[$j]['price']; ?></span>
